    ...
    while (true) {
        ...
        switch (choice) {
            case 1: {
                ...
                System.out.print("Enter class (10th, 11th, or 12th): ");
            ...
            case 2: {
                System.out.print("Enter class to view reports (10th, 11th, or 12th): ");
                String classLevel = sc.nextLine();
                boolean found = false;
            ...
            case 4: {
                System.out.print("Enter class to sort (10th, 11th, or 12th): ");
                String classLevel = sc.nextLine();
            ...
            case 5: {
                System.out.print("Enter class to save report (10th, 11th, or 12th): ");
                String classLevel = sc.nextLine();
                List<Student> filtered = new ArrayList<>();
                for (Student s : students) {
                    if (s.getClassLevel().equals(classLevel)) {
